# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-02-27 02:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skj.Account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skj.Account', verbose_name='会员名')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skj.Article')),
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='skj.Comment', verbose_name='父级评论')),
            ],
        ),
        migrations.CreateModel(
            name='UserAuthToken',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='skj.Account')),
            ],
        ),
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skj.ArticleSource', verbose_name='来源'),
        ),
